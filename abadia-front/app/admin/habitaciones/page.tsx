  ...
  useEffect(() => {
    const fetchHabitaciones = async () => {
      try {
        ...
        setHabitaciones([
          { id: "1", titulo: "Habitación 1", subtitulo: "Suite Insignia", precio: 450000, ocupacion: "Máx. 2 Adultos", estado: "DISPONIBLE" },
          { id: "2", titulo: "Habitación 2", subtitulo: "Refugio Rústico", precio: 320000, ocupacion: "Máx. 2 Adultos + 1 Niño", estado: "MANTENIMIENTO" },
        ]);
      } finally {
        setLoading(false);
      }
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-[var(--mv-sage)]/10">
              {loading ? (
                ...
                <tr>
                  <td colSpan={5} className="p-8 text-center text-gray-400">No hay habitaciones registradas.</td>
                </tr>
              ) : (
